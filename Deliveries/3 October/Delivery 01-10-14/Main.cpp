...
//	myfile << "Equity Bank "<< NBANKS-1 << ",";
	...
	for (int i = 0; i != NBANKS-1 ; i++)
		...
		networkOutputfile << "Partners Bank "<< NBANKS-1 << endl;
...
//		for (int i = 0; i != bnetwork->getBankCount()-1 ; i++)
		...
		//Partners info
		for (int i = 0; i != bnetwork->getBankCount()-1 ; i++)
		{networkOutputfile <<  (bnetwork->getBank(i))->printPartners()   << ",";}
		networkOutputfile << (bnetwork->getBank( bnetwork->getBankCount()-1 ))->printPartners() << endl;

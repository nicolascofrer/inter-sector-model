...
//DEPOSITOR
	Depositor::Depositor(): Loan::Loan(){quantity = 1; ID = 1; set_time_to_maturity(); expired = false;};
	void Depositor::set_time_to_maturity(){t_to_maturity = d.exponential( DepositorMaturityParameter); duration = t_to_maturity;}

//BORROWER
	Borrower::Borrower(): Loan::Loan(){quantity = 1; ID = 2; set_time_to_maturity(); expired = false;}

			...
			for (; iter != xb.end(); iter++)//We have to look at each new object coming
			{
				...
				if( ( (*iter).getType() == 1 ) | ( (*iter).getType() == 11) ) {
                    ...
                    /*NICO :
                        ...
                        I want to choice the action with higher payoff , with probability 1-e   and choice a random action with probability e  (  where e is trembling probability ) :  this is my problem 

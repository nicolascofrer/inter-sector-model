...
//		}
		...
		void Bank::UpdatePartnersSet(int a){
			...
			if( a == 1 ){
				...
				while( true ){ aux = BNetwork::getBank( (int) rand()%NBANKS); prevsize = PartnersVector.size(); if(aux!= this) PartnersVector.insert( aux ); if(PartnersVector.size()!=prevsize) break;}

#include "adevs.h"
#include "Agent.h"
#define BorrowerMaturityParameter	0.6
#define DepositorMaturityParameter	0.6
...
//DEPOSITOR
	Depositor::Depositor(): Loan::Loan(){quantity = 1; ID = 1; set_time_to_maturity();};
	void Depositor::set_time_to_maturity(){t_to_maturity = d.exponential( DepositorMaturityParameter); }

//BORROWER
	Borrower::Borrower(): Loan::Loan(){quantity=2; ID = 2; set_time_to_maturity();}

...
#define NMAX 1000 //Reserve columns for new banks
...
#define BorrowerMaturityParameter	1
//3. Customer Deposits maturity parameter.							.003968254, 1 day
#define DepositorMaturityParameter	1
//Generator param
...
#define CBDFR [0.015/252]
//2. Lending facility rate in ]0,1[,							.035
#define CBLFR [0.035/252]
...
#define customerDepositInterestRate	[0.025/252]
